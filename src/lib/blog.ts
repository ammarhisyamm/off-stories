...
export const blogPosts: BlogPost[] = [
  {
    ...
    relatedSlugs: [
      "budget-pernikahan-indonesia",
      "rundown-resepsi-wedding-4-jam",
      "nikah-jakarta-budget-50-juta",
    ],
    keywords: [
      "timeline pernikahan",
      "checklist 12 bulan sebelum nikah",
      "wedding timeline indonesia",
    ],
  ...
  },
  {
    ...
    relatedSlugs: [
      "budget-pernikahan-indonesia",
      "checklist-12-bulan-sebelum-nikah",
      "cara-negosiasi-harga-vendor",
    ],
    keywords: [
      "budget wedding jakarta 50 juta",
      "nikah di jakarta budget 50 juta",
      "biaya pernikahan jakarta",
    ],
  ...
  },
  {
    ...
    keywords: [
      "budget pernikahan indonesia",
      "budget wedding indonesia",
      "cara membagi budget nikah",
    ],
  ...
  },
  {
    ...
    keywords: [
      "interview vendor katering",
      "tips pilih katering wedding",
      "pertanyaan untuk katering",
    ],
  ...
  },
  {
    ...
    relatedSlugs: [
      "rsvp-seating-check-in-pernikahan",
      "interview-vendor-katering",
      "panduan-adat-pernikahan-jawa",
    ],
  ...
  },
  {
    ...
    keywords: [
      "skincare pre wedding",
      "perawatan kulit sebelum nikah",
      "rutinitas skincare 6 bulan",
    ],
    ...
    faqs: [
      {
        ...
        answer: "Umumnya 2–4 jam per lokasi, tergantung paket dan jumlah outfit.",
      },
      {
  ...
  },
  {
    ...
    keywords: [
      "komunikasi pasangan",
      "budget wedding diskusi",
      "hubungan sehat saat persiapan nikah",
    ],
  ...
  },
  {
    ...
    keywords: [
      "template budget pernikahan",
      "template anggaran nikah excel",
      "contoh budget wedding",
      "cara menyusun budget nikah",
    ],
  ...
  },
  {
    ...
    keywords: [
      ...
      "contoh kata undangan nikah",
      "cara buat undangan online",
    ],
      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            ...
            [
              "Gedung atau rumah",
              "Rp 600.000 + biaya penghulu transport",
              "Sesuai kesepakatan wajar",
            ],
          ],
        },
      },
  ...
  },
  {
    ...
    relatedSlugs: [
      "tips-pose-natural-prewedding",
      "cara-negosiasi-harga-vendor",
      "budget-pernikahan-indonesia",
    ],
    keywords: [
      "biaya prewedding",
      "paket prewedding murah",
      "harga foto prewedding",
      "tips hemat prewedding",
    ],
  ...
  },
  {
    ...
    keywords: [
      ...
      "contoh menu catering wedding",
      "harga catering per pax",
      "tips pilih menu prasmanan",
    ],
  ...
  },
  {
    ...
    keywords: [
      ...
      "aplikasi pernikahan gratis",
      "wedding planner online indonesia",
      "aplikasi budget nikah",
    ],
  ...
  },
  {
    ...
    relatedSlugs: [
      "checklist-12-bulan-sebelum-nikah",
      "aplikasi-wedding-planner-gratis",
      "budget-pernikahan-indonesia",
    ],
    keywords: [
      "checklist pernikahan excel",
      "download checklist nikah",
      "template checklist wedding",
      "daftar tugas pernikahan",
    ],
  ...
  },
  {
    ...
    relatedSlugs: [
      "budget-pernikahan-indonesia",
      "nikah-jakarta-budget-50-juta",
      "komunikasi-pasangan-soal-budget",
    ],
    keywords: [
      "template budget pernikahan",
      "rincian biaya nikah",
      "cara membuat budget wedding",
      "alokasi budget nikah",
    ],
  ...
  },
  {
    ...
    keywords: [
      "daftar tamu undangan excel",
      "cara mengatur tamu pernikahan",
  ...
  {
    slug: "budget-nikah-100-juta",
    title: "Budget Nikah Rp100 Juta: Contoh Alokasi yang Realistis di Indonesia",
    excerpt:
      "Contoh pembagian budget nikah Rp100 juta untuk pasangan yang ingin tetap punya prioritas jelas tanpa memaksakan semua elemen sekaligus.",
    categoryId: "planning-budget",
    publishedAt: "2026-09-09",
    updatedAt: "2026-09-09",
    readingTime: "6 menit baca",
    author: offStoriesAuthor,
    intro:
      "Budget Rp100 juta bisa cukup untuk pernikahan yang hangat dan terencana, tetapi bukan berarti semua komponen harus dibuat besar. Kuncinya adalah memutuskan skala tamu, format venue, dan tiga prioritas yang tidak ingin dikompromikan sejak awal.",
    sections: [
      {
        heading: "Contoh alokasi awal",
        paragraphs: [
          "Untuk acara sekitar 150–250 pax di kota dengan biaya menengah, gunakan alokasi awal sebagai alat diskusi, bukan harga final vendor.",
        ],
        table: {
          headers: ["Kategori", "Range awal"],
          rows: [
            ["Catering", "Rp30–35 juta"],
            ["Venue dan kebutuhan teknis", "Rp20–25 juta"],
            ["Busana, MUA, dan dokumentasi", "Rp18–22 juta"],
            ["Dekorasi, undangan, dan hiburan", "Rp12–15 juta"],
            ["Cadangan", "Rp8–10 juta"],
          ],
        },
      },
      {
        heading: "Keputusan yang paling mengubah angka",
        paragraphs: [
          "Jumlah pax dan kota adalah penggerak biaya terbesar. Tambahan 50 pax bukan hanya menaikkan catering, tetapi juga kursi, meja, souvenir, dan kebutuhan parkir. Paket vendor perlu dibandingkan berdasarkan isi, jam kerja, dan biaya tambahan, bukan hanya angka di halaman pertama.",
        ],
        bullets: [
          "Tentukan batas pax sebelum survey venue.",
          "Simpan DP, pelunasan, dan pengeluaran kecil dalam daftar yang sama.",
          "Sisihkan buffer sebelum menambah dekorasi atau entertainment.",
        ],
        callout: {
          title: "Mulai dari angka yang bisa diubah",
          body: "Gunakan kalkulator budget untuk melihat range dari kota dan jumlah tamu, lalu pindahkan hasilnya ke workspace agar setiap quotation bisa dibandingkan.",
        },
      },
    ],
    faqs: [
      {
        question: "Apakah Rp100 juta cukup untuk nikah di Jakarta?",
        answer:
          "Bisa untuk format yang lebih intimate atau dengan prioritas vendor yang tegas. Untuk venue premium dan tamu besar, range ini biasanya perlu ditambah atau format acara disederhanakan.",
      },
      {
        question: "Budget paling aman dibuat per kategori atau per vendor?",
        answer:
          "Mulai dari kategori agar porsinya sehat, lalu tambahkan vendor dan jadwal pembayaran saat quotation sudah masuk.",
      },
    ],
    relatedSlugs: [
      "budget-pernikahan-indonesia",
    ...
    keywords: [
      "budget nikah 100 juta",
      "rincian biaya pernikahan 100 juta",
      "budget wedding indonesia",
    ],
    tags: ["budget", "biaya nikah", "alokasi"],
    published: true,
  },
  {
    slug: "persiapan-nikah-mulai-dari-mana",
    title: "Persiapan Nikah Mulai dari Mana? Urutan Pertama untuk Pasangan Indonesia",
    excerpt:
      "Urutan keputusan pertama agar persiapan nikah tidak langsung berubah menjadi daftar tugas yang terlalu panjang.",
    categoryId: "planning-budget",
    publishedAt: "2026-09-09",
    updatedAt: "2026-09-09",
    readingTime: "5 menit baca",
    author: offStoriesAuthor,
    intro:
      "Saat baru mulai, semua hal terasa mendesak: venue, keluarga, adat, tamu, dan vendor. Padahal urutannya sederhana. Buat fondasi keputusan dulu, baru pilih vendor dan detail yang bergantung pada fondasi itu.",
    sections: [
      {
        heading: "Empat keputusan pembuka",
        paragraphs: [
          "Sepakati empat hal ini berdua sebelum meminta quotation: target tanggal, kota acara, kisaran jumlah pax, dan range budget. Keempatnya menentukan kapasitas venue, pilihan vendor, serta waktu booking yang masuk akal.",
        ],
        ordered: [
          "Pilih dua sampai tiga tanggal yang realistis.",
          "Tentukan kota dan format acara utama.",
          "Buat perkiraan pax per pihak keluarga.",
          "Tetapkan range budget dan siapa yang menanggung kategori utama.",
        ],
      },
      {
        heading: "Setelah fondasi sudah ada",
        paragraphs: [
          "Baru setelah itu mulailah checklist dan shortlist venue. Jika ada adat atau acara keluarga seperti lamaran dan pengajian, masukkan sejak awal agar jadwal, seserahan, dan komunikasi antar keluarga tidak menjadi pekerjaan dadakan.",
        ],
        callout: {
          title: "Rekomendasi singkat",
          body: "Jangan mulai dari moodboard. Mulai dari tanggal, pax, dan budget—lalu biarkan konsep berkembang dari keputusan yang benar-benar bisa dijalankan.",
        },
      },
    ],
    faqs: [
      {
        question: "Berapa lama idealnya menyiapkan pernikahan?",
        answer:
          "Sekitar 9–12 bulan memberi ruang lebih baik untuk venue populer dan keputusan keluarga, tetapi acara yang lebih kecil bisa direncanakan lebih cepat jika prioritasnya tegas.",
      },
      {
        question: "Perlu langsung memakai WO?",
        answer:
          "Tidak selalu. WO membantu koordinasi dan eksekusi; untuk keputusan awal, pasangan tetap perlu menyepakati data dasar acara terlebih dahulu.",
      },
    ],
    relatedSlugs: [
      "checklist-12-bulan-sebelum-nikah",
    ...
    keywords: [
      ...
      "urutan persiapan pernikahan",
      "planning wedding indonesia",
    ],
    tags: ["persiapan", "checklist", "planning"],
    published: true,
  },
  {
    slug: "cara-memilih-vendor-pernikahan",
    title: "Cara Memilih Vendor Pernikahan: Checklist Sebelum Bayar DP",
    excerpt:
      "Cara membandingkan vendor wedding secara praktis—dari scope paket dan timeline sampai kontrak serta jadwal pembayaran.",
    categoryId: "vendor-venue",
    publishedAt: "2026-09-09",
    updatedAt: "2026-09-09",
    readingTime: "6 menit baca",
    author: offStoriesAuthor,
    intro:
      "Vendor yang tepat bukan selalu yang paling viral atau paling murah. Pilihan yang aman adalah vendor dengan scope jelas, komunikasi cepat, kontrak yang bisa dibaca, dan jadwal kerja yang sesuai dengan kebutuhan acara kalian.",
    sections: [
      {
        heading: "Bandingkan scope, bukan angka paket",
        paragraphs: [
          "Minta penjelasan tertulis tentang output, jumlah kru, jam kerja, revisi, transport, overtime, dan biaya tambahan. Dua paket dengan harga sama dapat memiliki hasil dan risiko yang sangat berbeda pada hari H.",
        ],
        bullets: [
          "Cek portofolio yang relevan dengan skala dan venue kalian.",
          "Tanyakan PIC yang hadir pada hari H, bukan hanya sales.",
          "Catat nilai DP, jatuh tempo, dan kondisi pembatalan.",
          "Simpan quotation dan kontrak dalam folder yang sama.",
        ],
      },
      {
        heading: "Urutan booking yang aman",
        paragraphs: [
          "Biasanya venue, catering, foto-video, dan MUA masuk lebih awal karena jadwalnya cepat penuh. Setelah tanggal dan venue kuat, vendor lain lebih mudah menyesuaikan. Hindari membayar DP sebelum tanggal, kontak PIC, dan detail deliverable tertulis.",
        ],
        callout: {
          title: "Satu sumber kebenaran",
          body: "Masukkan setiap vendor, quotation, dan due date ke satu workspace. Cara ini mengurangi risiko dua pihak keluarga membayar atau menjanjikan hal yang berbeda.",
        },
      },
    ],
    faqs: [
      {
        question: "Berapa vendor yang perlu dibandingkan?",
        answer:
          "Dua sampai tiga vendor yang benar-benar sesuai sudah cukup. Terlalu banyak shortlist membuat keputusan tertunda tanpa menambah kualitas perbandingan.",
      },
      {
        question: "Apa yang harus ada di kontrak vendor?",
        answer:
          "Nama layanan, tanggal, jam kerja, output, pembayaran, kebijakan pembatalan, kontak PIC, dan detail biaya tambahan yang mungkin terjadi.",
      },
    ],
    relatedSlugs: [
      "cara-negosiasi-harga-vendor",
    ...
    keywords: [
      "cara memilih vendor pernikahan",
      "checklist vendor wedding",
      "kontrak vendor nikah",
    ],
    tags: ["vendor", "kontrak", "planning"],
    published: true,
  },
];
